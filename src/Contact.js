...
class Contact extends Component {
  render() {
    return (
      <div class = "container">
        <h1 class="text-center title borders imgbg"><Fade bottom>Contacto</Fade></h1>
        ...
        <Fade bottom>
          ...
          <div class="form-group">
            <label for="exampleFormControlInput1"><i>Nombre completo:</i></label>
            <input class="form-control" id="exampleFormControlInput1" type="name" name="name" placeholder="Victor Larraguibel"/>
          </div>
          <div class="form-group">
            <label for="exampleFormControlInput1"><i>Correo Electronico:</i></label>
            <input type="email" class="form-control" id="exampleFormControlInput2" type="email" name="email" placeholder="tucorreo@aqui.com"/>
          </div>
          <div class="form-group">
            <label for="exampleFormControlSelect1"><i>Tema:</i></label>
          ...
          <div class="form-group">
            <label for="exampleFormControlTextarea1"><i>Escribe aqui tu comentario:</i></label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Escribenos tu comentario" name="message"></textarea>
          </div>
          <button type="submit" class ="btn NoMargin btn-dark boxshadow"><i>Enviar</i></button>
          </form>
        </Fade>
